...
class RegisterCustomerPage : ComponentActivity() {
        ...
        ButtonRegister!!.setOnClickListener {
            if (EditTextUserName!!.text.toString().isEmpty() ||
                ...
                if (dbHelper!!.RegisterCustomer(customer)) {
                    ...
                    val `in` = Intent(this@RegisterCustomerPage, LoginCustomerPage::class.java)
                    startActivity(`in`)
                } else {
    ...
    fun Login(view: View?) {
        val `in` = Intent(this, LoginCustomerPage::class.java)
        startActivity(`in`)
    }
}
