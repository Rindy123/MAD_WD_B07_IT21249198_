...
class AcceptedOrderAdapter(private val context: Context, arrayList: ArrayList<DataRetriveProduct>) :
    RecyclerView.Adapter<AcceptedOrderAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(context, DoneProduct::class.java)
