...
class CustomerAdapterAdmin(
    private val context: Context,
    arrayList: ArrayList<CustomersDataRetrive>
) :
    RecyclerView.Adapter<CustomerAdapterAdmin.Holder>() {
    private val arrayList: ArrayList<CustomersDataRetrive>
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        val model: CustomersDataRetrive = arrayList[position]
        //get for view
    ...
    private fun DeleteItem(id: String) {
        ...
        builder.setPositiveButton(
            ...
            (context as ManageCustomers).onResume()
